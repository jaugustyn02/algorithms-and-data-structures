...
# Wyjątek dla k=1, linked lista sortowana analogicznie do Bubble Sort, bez tworzenia dodatkowych struktur,
# co ma na celu zmniejszenie czasu wykonywania się dla dużych n.
# Złożoność czasowa O(nlog(k))
# Złożoność czasowa względem k:
# dla k=O(1) wynosi O(n)
# dla k=O(logn) wynosi O(nlog(log(n)))
